...
public class LibraryServiceImpl implements LibraryService {
	...
	@Override
	public boolean addBook(String title, String author, String genre, String price, String isbn)
			throws ServiceException, ServiceEmptyFieldsException, ServicePriceException, ServiceIsbnException {
	...
	@Override
	public List<Book> find(String textFind) throws ServiceException {
		////////////////////////////////////////////////////
		DAOFactory factory = DAOFactory.getInstance();
		UserDAO userDAO = factory.getUserDAO();
		///////////////////////////////////////////////////
